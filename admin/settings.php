...
<body classs="bg-light">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button"
                                        ...
                                        class="btn text-secondary shadow-none" data-bs-dismiss="modal">CANCEL
                                    </button>
                                    <button type="button" onclick="upd_general(site_title.value, site_about.value)"
                                        class="btn custom-bg text-white shadow-none">SUBMIT
    ...
    function upd_general(site_title_val, site_about_val) {
        ...
        xhr.onload = function() {
            ...
            var myModa = document.getElementById('general-s');
